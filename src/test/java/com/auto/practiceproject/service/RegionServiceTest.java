...
public class RegionServiceTest {
  ...
  @MockBean private RegionDAO regionDAO;
  ...
  public void findRegionByIdTest() {
    Mockito.when(regionDAO.findById(1l)).thenReturn(Optional.of(regionData.get(0)));
  ...
  public void findRegionByIdIsNullTest() {
    ...
    Exception exception =
        assertThrows(ResourceException.class, () -> regionService.findRegionById(3L));
    Assert.assertTrue(exception.getMessage().contains("Region with Id: 3 not found"));
  }
