...
public class AutoModelServiceTest {
    ...
    public void findAllAutoModelsTest() {
        Mockito.when(autoModelDAO.findAll(nullable(Specification.class)))
                .thenReturn(autoModelData);
    ...
    public void findAutoModelByIdTest() {
        Mockito.when(autoModelDAO.findById(1l))
                .thenReturn(Optional.of(autoModelData.get(0)));
    ...
    public void findAutoModelByIdIsNullTest() {
        ...
        Exception exception = assertThrows(
                ...
                () -> autoModelService.findAutoModelById(3L));
        Assert.assertTrue(exception.getMessage().contains(
                "Auto model with Id: 3 not found"
        ));
    }
