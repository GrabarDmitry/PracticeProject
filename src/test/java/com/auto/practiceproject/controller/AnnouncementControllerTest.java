...
public class AnnouncementControllerTest {
  ...
  public void getAllAnnouncementsWithPageableTest() throws Exception {
    mockMvc
        .perform(get("/api/announcement").queryParam("size", "1").queryParam("page", "2"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
  ...
  public void getAnnouncementByIdTest() throws Exception {
    mockMvc
        .perform(get("/api/announcement/{id}", 3L))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
  ...
  public void getAnnouncementByIdFailTest() throws Exception {
    testUtil.exceptionCheck(
        mockMvc
            .perform(get("/api/announcement/{id}", 10L))
            .andDo(print())
  ...
  public void createAnnouncementTest() throws Exception {
    AnnouncementRequestDTO requestDTO =
        new AnnouncementRequestDTO(
            1L,
            "descriptionTest",
            "375296836539",
            4000D,
            ...
            3L,
            0D);
    responseDTOTestHelper.announcementResponseDTOCheck(
        mockMvc
            .perform(
                testUtil
                    .postJson("/api/announcement", requestDTO)
                    .with(testUtil.authentication("Dzmitry@mail.ru")))
            .andExpect(status().isCreated())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON)),
        new AnnouncementResponseDTO(
            5L, "BMW X5", "descriptionTest", "375296836539", 4000D, true, true, 0D, 1L, 3L, 5L));
  }
  ...
  public void announcementRatingUpTest() throws Exception {
    mockMvc
        .perform(
            post("/api/announcement/{id}/up", 3L).with(testUtil.authentication("Dzmitry@mail.ru")))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.id").value(3L));
  ...
  public void announcementRatingUpFailPermissionTest() throws Exception {
    testUtil.exceptionCheck(
        mockMvc
            .perform(
                post("/api/announcement/{id}/up", 2L)
                    .with(testUtil.authentication("Dzmitry@mail.ru")))
            .andDo(print())
  ...
  public void announcementRatingUpFailNotEnoughMoneyTest() throws Exception {
    testUtil.exceptionCheck(
        mockMvc
            .perform(
                post("/api/announcement/{id}/up", 2L).with(testUtil.authentication("user@mail.ru")))
            .andDo(print())
            .andExpect(status().isBadRequest())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON)),
        "400",
  ...
  public void changeAnnouncementActiveTest() throws Exception {
    AnnouncementActiveChangeDTO activeChangeDTO = new AnnouncementActiveChangeDTO(false);
    mockMvc
        .perform(
            testUtil
  ...
  public void updateAnnouncementTest() throws Exception {
    ...
    responseDTOTestHelper.announcementResponseDTOCheck(
        mockMvc
            .perform(
                testUtil
                    .putJson("/api/announcement/{id}", requestDTO, 3L)
                    .with(testUtil.authentication("Dzmitry@mail.ru")))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON)),
        new AnnouncementResponseDTO(
            3L, "BMW X5", "descriptionTest", "375296836539", 4000D, true, true, 0D, 1L, 3L, 3L));
  }
  ...
  public void updateAnnouncementFailPermissionTest() throws Exception {
    ...
    testUtil.exceptionCheck(
        mockMvc
            .perform(
                testUtil
                    .putJson("/api/announcement/{id}", requestDTO, 10L)
                    .with(testUtil.authentication("Dzmitry@mail.ru")))
            .andExpect(status().isForbidden())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON)),
        "403",
