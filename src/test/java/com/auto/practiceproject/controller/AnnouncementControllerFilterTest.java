...
public class AnnouncementControllerFilterTest {
  ...
  public void filterByBrandTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "autoBrandId.eq.1"))
        .andDo(print())
  ...
  public void filterByModelTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "autoModelId.eq.1"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(1L));
  ...
  public void filterByPriceTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "price.eq.5000"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(1L))
  ...
  public void filterByPriceMoreThanTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "price.more.4000"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
  ...
  public void filterByPriceLessThanTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "price.less.8000"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(1L))
  ...
  public void filterByReleasedYearTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "autoReleasedYearId.eq.1"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(1L));
  ...
  public void filterByMileageTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "mileage.eq.223"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(2L));
  ...
  public void filterByMileageMoreThanTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "mileage.more.1000"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(1L))
  ...
  public void filterByMileageLessThanTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "mileage.less.1000"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(2L));
  ...
  public void filterByEngineCapacityTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "engineCapacity.eq.1900"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(2L));
  ...
  public void filterByEngineCapacityMoreThanTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "engineCapacity.more.1900"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(1L));
  ...
  public void filterByEngineCapacityLessThanTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "engineCapacity.less.1900"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
  ...
  public void filterByEngineTypeTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "autoEngineId.eq.3"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(1L));
  ...
  public void filterByTransmissionTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "autoTransmissionId.eq.2"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(2L))
  ...
  public void filterByRegionTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "regionId.eq.3"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(2L))
  ...
  public void filterByCustomsDutyTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "customsDuty.eq.0"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(2L))
  ...
  public void filterByIsExchangeTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/announcement", "isExchange.eq.true"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
        .andExpect(jsonPath("$.content.[0].id").value(2L));
  ...
  public void filterFailTest() throws Exception {
    testUtil.exceptionCheck(
        this.mockMvc
            .perform(testUtil.getWithFilter("/api/announcement", "test.eq.test"))
            .andDo(print())
