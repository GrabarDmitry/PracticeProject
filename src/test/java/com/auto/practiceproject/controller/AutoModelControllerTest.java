...
public class AutoModelControllerTest {
  ...
  public void findAllAutoModelWithFilterByBrandTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/model", "autoBrandId.eq.1"))
        .andDo(print())
  ...
  public void findAllAutoModelWithFilterByReleasedYearTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/model", "autoReleasedYearId.eq.4"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
  ...
  public void findAllAutoModelWithFilterByTitleTest() throws Exception {
    this.mockMvc
        .perform(testUtil.getWithFilter("/api/model", "title.eq.Maybach"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
    ...
    this.mockMvc
        .perform(
            testUtil.getWithFilter(
                "/api/model", "title.eq.X3;autoReleasedYearId.eq.3;autoBrandId.eq.1"))
        .andDo(print())
        .andExpect(status().isOk())
        .andExpect(content().contentType(MediaType.APPLICATION_JSON))
