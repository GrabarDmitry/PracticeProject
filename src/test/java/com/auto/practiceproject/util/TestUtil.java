...
public class TestUtil {
  ...
  @Autowired private TokenProvider provider;
  ...
  public MockHttpServletRequestBuilder patchJson(String uri, Object body, Long paramValue)
      throws JsonProcessingException {
    String json = objectToJson(body);
  ...
  public MockHttpServletRequestBuilder patchJson(String uri, Object body)
      throws JsonProcessingException {
    String json = objectToJson(body);
    return patch(uri)
        .contentType(MediaType.APPLICATION_JSON)
  ...
  public MockHttpServletRequestBuilder putJson(String uri, Object body, Long paramValue)
      throws JsonProcessingException {
    String json = objectToJson(body);
  ...
  public ResultActions exceptionCheck(
      ResultActions resultActions, String statusCode, String statusType, String message)
      throws Exception {
    return resultActions
        .andExpect(jsonPath("$.httpStatusCode").value(statusCode))
