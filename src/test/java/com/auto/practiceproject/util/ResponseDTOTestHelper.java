...
public class ResponseDTOTestHelper {
  ...
  public ResultActions announcementResponseDTOCheck(
      ResultActions resultActions, AnnouncementResponseDTO responseDTO) throws Exception {
  ...
  public ResultActions userResponseDTOCheck(
      ResultActions resultActions, UserResponseDTO userResponseDTO) throws Exception {
    return resultActions
