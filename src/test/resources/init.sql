...
INSERT INTO app_test.announcement(title, description, phone_number, price, is_active, is_moderation, rating, rating_up_price,
                         is_exchange,
...
INSERT INTO app_test.comment(text, created, user_id, announcement_id)
