...
public class UserDTOConverter {
  ...
  public UserResponseDTO toDTO(User user) {
    ...
    return new UserResponseDTO(
        ...
        user.getName(),
        user.getSurname(),
        walletService.findWalletByUser(user).get().getId());
  }
  ...
  public User toEntityCreate(UserCreateDTO createDTO) {
    ...
    return new User(
        ...
        Set.of(roleService.findRoleByTitle("USER").orElse(null)));
  }
  ...
  public User toEntityCreate(ModeratorUserCreateDTO createDTO) {
    ...
    return new User(
        ...
        null,
        Set.of(
            roleService.findRoleByTitle("MODERATOR").orElse(null),
            roleService.findRoleByTitle("USER").orElse(null)));
  }
}
