...
public class AnnouncementDTOConverter {
    ...
    public Announcement toEntity(AnnouncementRequestDTO createDTO) {
        ...
        Auto auto = autoDTOConverter.toEntityCreate(new AutoRequestDTO(
    ...
    public Announcement updateToEntity(Long id, AnnouncementRequestDTO updateDTO) {
        ...
        Auto auto = autoDTOConverter.toEntityUpdate(
                announcement.getAuto().getId()
                , new AutoRequestDTO(
        ...
        announcement.setTitle(auto.getAutoModel().getAutoBrand().getTitle() + " " + auto.getAutoModel().getTitle());
